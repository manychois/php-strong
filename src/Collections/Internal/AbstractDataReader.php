...
/**
 * Implements the reading logic shared by every data reader, over a source supplied by the subclass.
 *
 ...
 * @internal
 */
abstract class AbstractDataReader implements IDataReader
{
    /**
     * Creates a reader over a value nested inside this one.
     *
     * @param array|object $source The array or object the new reader reads from.
     *
     * @return IDataReader The reader over the nested value.
     *
     * @phpstan-param array<array-key,mixed>|object $source
     */
    abstract protected function createReader(array|object $source): IDataReader;

    /**
     * Returns the array or object being read.
     *
     * @return array|object The source of this reader.
     *
     * @phpstan-return array<string,mixed>|object
     */
    abstract protected function source(): array|object;
    ...
    public function entries(): array
    {
        ...
        return self::stringKeyed(get_object_vars($source));
    }
     ...
     */
    #[Override]
    public function reader(string $key): IDataReader
    {
        $value = $this->get($key);
     ...
     */
    protected static function stringKeyed(array $source): array
    {
        $entries = [];
